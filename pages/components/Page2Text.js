const Page2Text = () => {
  return (
    <div className={`text2-block`}>
      <h2 className={`page2-title`}>Sociedade sem escola</h2>
      ...
      <p className={`page2-p2`}>
        ...
        qualquer recurso educacional:
      </p>

      <ol className={`page2-list`}>
        <li>
          Serviço de consulta a objetos educacionais armazenados em bibliotecas,
          laboratório, museus, teatros etc.;
        </li>
        <li>Intercâmbio de habilidade;</li>
        <li>
          Encontro de colegas (pessoas interessadas no mesmo tipo de pesquisa);
        </li>
        <li>
          Serviço de consulta a educadores e limitados ao importante papel de
